...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->connect_error) {
        ...
        $stmt = $conn->prepare("INSERT INTO bank (gst_number ,account_no,IFSC ) VALUES (?, ? , ?)");
        $stmt->bind_param("sss",$gst_number ,$account_no ,$IFSC);
        $stmt->execute();
        $stmt->close();
        $conn->close();
    }
    ...
    echo "  window.location.href = 'publisherprocess.html';";
