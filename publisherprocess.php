...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // Assuming the link is provided in the form
    
    // Database connection parameters
    $servername = "localhost";
    $username = "root";
    $password = "";
    $dbname = "tesst"; // Adjust this to your database name
    ...
    $stmt = $conn->prepare("INSERT INTO booksearch (topic, Book_name, author, link, images, price, Description) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $topic, $Book_name, $author, $link, $images, $price, $Description);
